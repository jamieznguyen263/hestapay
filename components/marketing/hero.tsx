...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-background py-20 lg:py-28">
      <Container>
        <div className="grid gap-12 items-center lg:grid-cols-2 lg:gap-16">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 max-w-xl text-lg text-muted leading-relaxed sm:text-xl">
              ...
              orchestrate your workflows, and grow — all from one platform.
            </p>
          ...
          {/* Right: product visual composition — layered UI panels */}
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            <div className="absolute z-30 -top-3 right-6 flex h-10 w-10 items-center justify-center rounded-full bg-primary shadow-lg shadow-primary/25">
